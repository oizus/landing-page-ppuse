...
function sendEmail(formData, setShowAlert, setShowErrorAlert, setFormDisabled) {
...
export default function Contato() {
	...
	const onSubmit = (data) => {
        ...
        setShowAlert(false);
        sendEmail(data, setShowAlert, setShowErrorAlert, setFormDisabled);	
				...
				<div className={styles.form}>
					...
					>
						...
						<div className={styles.divButton}>
							<Box mt={2}>
								<button variant="contained" onClick={handleSubmit(onSubmit)} className={styles.enviarButton} disabled={formDisabled}>
									Enviar
								</button>
							</Box>
						</div>
